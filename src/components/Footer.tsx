      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h2 className="text-xl font-bold">SimpleSite</h2>
            <p className="mt-2 text-gray-300">
              Creating beautiful websites has never been easier. Start your journey today.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">Cookies</a></li>
